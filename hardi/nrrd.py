# -*- coding: utf-8 -*-
"""
Created on Fri Feb  7 07:41:32 2014
...
_NRRD_FIELD_PARSERS = {
    ...
    'thicknesses': lambda fieldValue: [str(x) for x in fieldValue.split(' ')],
...
def _parse_fields(raw_fields):
    ...
    for field, value in raw_fields.iteritems():
        if field not in _NRRD_FIELD_PARSERS:
            ...
            # SHIREEN
            print 'Unexpected field in nrrd header: "%s", it will be ignored' % (field)
            continue
